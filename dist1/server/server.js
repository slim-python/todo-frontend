...
const _f5981d06 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 46)));
...
const LazyLogo = Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 16)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
const components = {
  Logo: () => Promise.resolve(/* import() */).then(__webpack_require__.bind(null, 16)).then(c => wrapFunctional(c.default || c))
};
...
var external_vue_apollo_ = __webpack_require__(11);
...
var polyfill_ = __webpack_require__(42);

// EXTERNAL MODULE: external "apollo-client"
var external_apollo_client_ = __webpack_require__(20);
...
var external_apollo_upload_client_ = __webpack_require__(21);

// EXTERNAL MODULE: external "apollo-cache-inmemory"
var external_apollo_cache_inmemory_ = __webpack_require__(7);

// EXTERNAL MODULE: external "subscriptions-transport-ws"
var external_subscriptions_transport_ws_ = __webpack_require__(22);

// EXTERNAL MODULE: external "subscriptions-transport-ws/dist/message-types"
var message_types_ = __webpack_require__(23);
var message_types_default = /*#__PURE__*/__webpack_require__.n(message_types_);

// EXTERNAL MODULE: external "apollo-link-ws"
var external_apollo_link_ws_ = __webpack_require__(24);

// EXTERNAL MODULE: external "apollo-utilities"
var external_apollo_utilities_ = __webpack_require__(25);

// EXTERNAL MODULE: external "apollo-link-persisted-queries"
var external_apollo_link_persisted_queries_ = __webpack_require__(26);

// EXTERNAL MODULE: external "apollo-link-context"
var external_apollo_link_context_ = __webpack_require__(27);

// EXTERNAL MODULE: external "apollo-link-state"
var external_apollo_link_state_ = __webpack_require__(28);
...
var external_universal_cookie_ = __webpack_require__(29);
...
/* harmony default export */ var apollo_module = ((ctx, inject) => {
  ...
  defaultClientConfig = {
    "httpEndpoint": "https://intense-eyrie-90071.herokuapp.com/graphql"
  };
  ...
  if (true) {
    const ApolloSSR = __webpack_require__(43);
